...
/* Reduce padding, removed rounded corners, and add borders on tooltips: */
tooltip * {padding: 0px;}
...
/* Reduce padding on toolbar elements: */
toolbar {padding: 3px;}
toolbar.horizontal separator {margin: 0 5px 0px 4px;}
toolbar.vertical separator {margin: 5px 0px 5px 0;}
toolbar:not(.inline-toolbar):not(.osd) > *:not(.toggle):not(.popup) > * {margin-right: 1px; margin-bottom: 0px;}
toolbar.horizontal toolbutton button {padding: 0px 2px 0px 2px;}
